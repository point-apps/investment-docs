...
export const description =
  'In this guide, we will look at how to work with paginated responses when querying the Investment API'

# Pagination

In this guide, we will look at how to work with paginated responses when querying the Investment API. By default, all responses limit results to ten. However, you can go as high as 100 by adding a `limit` parameter to your requests.  {{ className: 'lead' }}
