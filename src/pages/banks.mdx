...
export const description =
  'On this page, we’ll dive into the different bank endpoints you can use to manage banks programmatically.'
...
## Archive a bank {{ tag: 'POST', label: '/v1/banks/:id/archive' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/banks/:id/archive">
    ```typescript {{ title: 'axios' }}
    const response = axios.post('/v1/banks/637d83d15d2be122007524bf/archive')
    ```
    </CodeGroup>
    <CodeGroup title="Response">
    ```json {{ title: '204' }}
...
## Restore a bank {{ tag: 'POST', label: '/v1/banks/:id/restore' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/banks/:id/restore">
    ```typescript {{ title: 'axios' }}
    const response = axios.post('/v1/banks/637d83d15d2be122007524bf/restore')
    ```
    </CodeGroup>
    <CodeGroup title="Response">
    ```json {{ title: '204' }}
...
## Request to delete the bank {{ tag: 'POST', label: '/v1/banks/:id/request-delete' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/banks/:id/request-delete">
    ```typescript {{ title: 'axios' }}
    const response = axios.post('/v1/banks/637d83d15d2be122007524bf/request-delete', {
      approvalTo: '',
      reasonDelete: '',
    })
    ```
...
## Approve request to delete the bank {{ tag: 'POST', label: '/v1/banks/:id/request-delete/approve' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/banks/:id/request-delete/approve">
    ```typescript {{ title: 'axios' }}
    const response = axios.post('/v1/banks/637d83d15d2be122007524bf/request-delete/approve')
    ```
    </CodeGroup>
    <CodeGroup title="Response">
    ```json {{ title: '204' }}
...
## Reject request to delete the bank {{ tag: 'POST', label: '/v1/banks/:id/request-delete/reject' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/banks/:id/request-delete/reject">
    ```typescript {{ title: 'axios' }}
    const response = axios.post('/v1/banks/637d83d15d2be122007524bf/request-delete/reject', {
      reasonReject: ""
    })
    ```
    </CodeGroup>
